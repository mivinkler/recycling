...
class HalleZweiListView(ListViewService, ListView):
    model = HalleZwei
    ...
    field_configs = [
        {"field": "delivery_unit__id", "label": "EID", "lookup": "exact"},
        {"field": "id", "label": "HID", "lookup": "exact"},
        {
        ...
        {"field": "delivery_unit__weight", "label": "Gewicht (kg)", "lookup": "exact"},
        {"field": "delivery_unit__barcode", "label": "Barcode"},
        {"field": "delivery_unit__note", "label": "Anmerkung"},
    ]
